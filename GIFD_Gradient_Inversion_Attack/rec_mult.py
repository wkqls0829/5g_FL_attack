...
nclass_dict = {'I32': 1000, 'I64': 1000, 'I128': 1000, 
               'CIFAR10': 10, 'CIFAR100': 100, 'LFW': 106, 'CA': 8, 'ImageNet':1000, 'IMAGENET_IO' : 1000,
    ...
    for i in range(config['num_exp']):   
        ...
        for idx, item in enumerate(result):
            ...
            if output is None :  #some layers were skiped 
                ...
                print(f"Rec. loss: {stats['opt']:2.4f} | MSE: {test_mse:2.4e} | LPIPS(VGG): {lpips_score:2.4f} | LPIPS(ALEX): {lpips_score_a:2.4f} | SSIM: {ssim_score:2.4f} | PSNR: {test_psnr:4.2f} | FMSE: {feat_mse:2.4e} | ")
